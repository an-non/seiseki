...
function createDatabase() {
  ...
  for (const name of [
    ...
    "0004_response_question_context.sql", "0005_rate_limits.sql", "0006_response_access_revision.sql", "0007_response_updated_at.sql", "0008_questionnaire_seven_structured.sql"
